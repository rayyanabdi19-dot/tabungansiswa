  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center"
        style={{
          backgroundImage: "url('/batik-pattern.jpg')",
      ...
      >
        ...
        <div className="relative z-10 max-w-lg p-12 animate-fade-in">
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mb-8 shadow-2xl shadow-primary/40 animate-float">
          ...
          <div className="grid grid-cols-2 gap-4">
            {features.map((f, i) => (
              <div
                key={i}
                className="p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 hover:scale-105 transition-all duration-300 group"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                <div className="w-10 h-10 rounded-xl bg-primary/30 flex items-center justify-center mb-3 group-hover:bg-primary/50 transition-colors">
      ...
      {/* Login Section */}
      <div className="flex-1 flex items-center justify-center p-4 md:p-8 bg-gradient-to-br from-background via-background to-primary/5 relative">
        {/* Decorative */}
        ...
        <div className="w-full max-w-md relative z-10 animate-fade-in">
          {/* Mobile header with batik */}
          <div className="text-center mb-8 lg:hidden">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mx-auto mb-4 shadow-xl shadow-primary/30 animate-float">
              <PiggyBank className="w-9 h-9 text-primary-foreground" />
            </div>
            <h1 className="text-2xl font-extrabold text-foreground">TabunganKu</h1>
            <p className="text-muted-foreground mt-1 text-sm">Sistem Tabungan Siswa Digital</p>
          </div>

          <Card className="bg-card/90 backdrop-blur-md border border-border/60 shadow-2xl shadow-primary/10">
            <CardContent className="pt-8 pb-8 px-6 md:px-8">
              <h2 className="text-2xl font-bold text-foreground mb-1 text-center">Selamat Datang 👋</h2>
              ...
              {loginRole === "admin" ? (
                <form onSubmit={handleAdminLogin} className="space-y-5">
                  ...
                  <Button type="submit" className="w-full h-12 text-base font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/35 transition-all duration-300" disabled={loading}>
